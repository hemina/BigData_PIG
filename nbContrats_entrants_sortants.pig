...
PNB_Contrat_1 = FOREACH PNB_Contrat GENERATE moisTraitement,cdSi,noCtrScr;
...
contrats_entrants_mois1_2 = FOREACH (GROUP contrats_entrants_mois1_2 ALL) GENERATE '2015-08-31' AS mois, COUNT_STAR(contrats_entrants_mois1_2) AS nb;
