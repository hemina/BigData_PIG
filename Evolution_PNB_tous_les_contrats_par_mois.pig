...
VI_group = GROUP PNB_Contrat_1 BY moisTraitement;

VI_par_mois = FOREACH VI_group GENERATE group AS moisTraitement,SUM(PNB_Contrat_1.PNB);

VI_par_mois = ORDER VI_par_mois BY moisTraitement;

STORE VI_par_mois INTO '/hdfs/staging/out/e1225/VI_par_mois' using PigStorage(',');
