...
nncc1 = JOIN contrat1 BY (cdSi,noPse) RIGHT, client1 BY (cdSi,noPse);
nncc1_grp = GROUP nncc1 ALL;
nnccnb1 = FOREACH nncc1_grp GENERATE FLATTEN(group), COUNT_STAR(nncc1) AS nbnncc;
...
STORE nnccnb1 INTO '/hdfs/staging/out/e1225/nnccnb1' using PigStorage(';');
...
STORE contrats_entrants INTO '/hdfs/staging/out/e1225/contrats_entrants' using PigStorage(';');
...
STORE clients_entrants INTO '/hdfs/staging/out/e1225/clients_entrants' using PigStorage(';');