...
--PNB_Contrat_1 = FILTER PNB_Contrat_1 BY (noCtrScr MATCHES '.*DL.*');

--contrat_target = ORDER PNB_Contrat_1 BY noCtrScr, cdSFam, noPse, mois;

--STORE contrat_target INTO '/hdfs/staging/out/e1225/explore' using PigStorage(';');
...
contrats_mois201505_06 = JOIN mois201506 BY (cdSi, noCtrScr, noPse, cdSFam) FULL, mois201505 BY (cdSi, noCtrScr, noPse, cdSFam);
contrats_mois201506_07 = JOIN mois201507 BY (cdSi, noCtrScr, noPse, cdSFam) FULL, mois201506 BY (cdSi, noCtrScr, noPse, cdSFam);
contrats_mois201507_08 = JOIN mois201508 BY (cdSi, noCtrScr, noPse, cdSFam) FULL, mois201507 BY (cdSi, noCtrScr, noPse, cdSFam);
contrats_mois201508_09 = JOIN mois201509 BY (cdSi, noCtrScr, noPse, cdSFam) FULL, mois201508 BY (cdSi, noCtrScr, noPse, cdSFam);
contrats_mois201509_10 = JOIN mois201510 BY (cdSi, noCtrScr, noPse, cdSFam) FULL, mois201509 BY (cdSi, noCtrScr, noPse, cdSFam);
contrats_mois201510_11 = JOIN mois201511 BY (cdSi, noCtrScr, noPse, cdSFam) FULL, mois201510 BY (cdSi, noCtrScr, noPse, cdSFam);
contrats_mois201511_12 = JOIN mois201512 BY (cdSi, noCtrScr, noPse, cdSFam) FULL, mois201511 BY (cdSi, noCtrScr, noPse, cdSFam);
contrats_mois201512_01 = JOIN mois201601 BY (cdSi, noCtrScr, noPse, cdSFam) FULL, mois201512 BY (cdSi, noCtrScr, noPse, cdSFam);
contrats_mois201601_02 = JOIN mois201602 BY (cdSi, noCtrScr, noPse, cdSFam) FULL, mois201601 BY (cdSi, noCtrScr, noPse, cdSFam);
contrats_mois201602_03 = JOIN mois201603 BY (cdSi, noCtrScr, noPse, cdSFam) FULL, mois201602 BY (cdSi, noCtrScr, noPse, cdSFam);
contrats_mois201603_04 = JOIN mois201604 BY (cdSi, noCtrScr, noPse, cdSFam) FULL, mois201603 BY (cdSi, noCtrScr, noPse, cdSFam);
...
STORE contrats_entrants INTO '/hdfs/staging/out/e1225/jointure/tmp_contrats_entrants' using PigStorage(';');
STORE clients_entrants INTO '/hdfs/staging/out/e1225/jointure/tmp_clients_entrants' using PigStorage(';');
...
nouveau_contrat = LOAD '/hdfs/staging/out/e1225/jointure/tmp_contrats_entrants' USING PigStorage(';') AS ( mois:chararray, 
cdSi:chararray,
noPse:chararray,
daOuv:chararray,
noCtrScr:chararray,
...
nouveau_client = LOAD '/hdfs/staging/out/e1225/jointure/tmp_clients_entrants' USING PigStorage(';') AS ( mois:chararray, 
cdSi:chararray,
noPse:chararray);
...
STORE nouveau_contrat INTO '/hdfs/staging/out/e1225/jointure/contrats_entrants' using PigStorage(';');
STORE nouveau_client INTO '/hdfs/staging/out/e1225/jointure/clients_entrants' using PigStorage(';');

-- On stocke les données après la jointure, les données pas très propre
STORE nouveau_contrat_ancien_client INTO '/hdfs/staging/out/e1225/jointure/nouveau_contrat_ancien_client' using PigStorage(';');
STORE nouveau_contrat_nouveau_client INTO '/hdfs/staging/out/e1225/jointure/nouveau_contrat_nouveau_client' using PigStorage(';');

-- On recharge les données, en faisant exprès d'enlever la deuxième partie de la jointure
nouveau_contrat_ancien_client = LOAD '/hdfs/staging/out/e1225/jointure/nouveau_contrat_ancien_client' USING PigStorage(';') AS ( mois:chararray, 
cdSi:chararray,
noPse:chararray,
daOuv:chararray,
noCtrScr:chararray,
...
nouveau_contrat_nouveau_client = LOAD '/hdfs/staging/out/e1225/jointure/nouveau_contrat_nouveau_client' USING PigStorage(';') AS ( mois:chararray,
cdSi:chararray,
noPse:chararray,
daOuv:chararray,
noCtrScr:chararray,
...
nouveau_contrat_ancien_client = ORDER nouveau_contrat_ancien_client BY mois, noCtrScr, noPse, cdSFam;
nouveau_contrat_nouveau_client = ORDER nouveau_contrat_nouveau_client BY mois, noCtrScr, noPse, cdSFam;

STORE nouveau_contrat_ancien_client INTO '/hdfs/staging/out/e1225/jointure/nouveau_contrat/ancien_client' using PigStorage(';');
STORE nouveau_contrat_nouveau_client INTO '/hdfs/staging/out/e1225/jointure/nouveau_contrat/nouveau_client' using PigStorage(';');